...
#        line_number = get_line_number(content, match.start())
        suggestions.append("Avoid using '{match.group()}'; use 'cancel' or 'stop' instead.")
...
#            line_number = get_line_number(content, match.start())
            suggestions.append("Ensure 'accessible' is used to refer to content usable by people with disabilities."
            )
...
#            line_number = get_line_number(content, match.start())
            suggestions.append("Consider using 'application' instead of 'app' for complex software."
            )
...
#            line_number = get_line_number(content, match.start())
            suggestions.append("Use 'automatic' instead of 'auto' when used as an adjective.")
