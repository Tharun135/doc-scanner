"""
Acce# Import the RAG helper for rule-based suggestions
try:
    from .rag_main import get_rag_suggestion, is_rag_available
except ImportError:
    def get_rag_suggestion(issue_text, sentence_context, category="accessibility"):
        return {"suggestion": f"Accessibility issue: {issue_text}", "confidence": 0.5}
    def is_rag_available():
        return Falsey and Inclusivity Rules
