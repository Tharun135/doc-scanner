...
#        line_number = get_line_number(content, match.start())
        suggestions.append("Avoid using 'above' to refer to previous content; use specific references.")
...
#        line_number = get_line_number(content, match.start())
    ...
    for match in matches:
#        line_number = get_line_number(content, match.start())
        suggestions.append("Avoid using 'and/or'; consider rephrasing for clarity.")
